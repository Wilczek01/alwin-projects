...
public class PrepareDbJUnitRunner extends DaoTestBase {
    ...
    @UsingDataSet({"test-permission.json", "test-data.json", "test-issue.json", "test-issue-invoice.json", "test-activity.json", "test-contract-out-of-service.json",
            ...
            "test-message-template.json", "test-notification.json", "test-scheduler-execution.json", "test-scheduler-configuration.json",
            "test-issue-type-activity-type.json", "test-contract-termination.json", "test-formal-debt-collection-customer-out-of-service.json",
