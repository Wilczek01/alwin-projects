 ...
 */
@Component({
  selector: 'alwin-issued-terminations',
  styleUrls: ['./issued-terminations.component.css'],
  templateUrl: './issued-terminations.component.html'
})
export class IssuedTerminationsComponent implements OnInit {
