 ...
 */
@Component({
  selector: 'alwin-rejected-terminations',
  styleUrls: ['./rejected-terminations.component.css'],
  templateUrl: './rejected-terminations.component.html'
})
export class RejectedTerminationsComponent implements OnInit {
