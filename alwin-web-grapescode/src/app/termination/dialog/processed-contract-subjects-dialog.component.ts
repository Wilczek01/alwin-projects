 ...
 */
@Component({
  selector: 'alwin-processed-contract-subjects-dialog',
  styleUrls: ['./processed-contract-subjects-dialog.component.css'],
  templateUrl: './processed-contract-subjects-dialog.component.html'
})
export class ProcessedContractSubjectsDialogComponent implements OnInit {
