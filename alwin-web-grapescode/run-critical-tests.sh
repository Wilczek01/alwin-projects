...
ng e2e --specs=./e2e/critical/**/*.e2e-spec.ts --base-href=https://qa.grapescode.pl/alwin-web/ --serve=false

#Przydatne przy implementacji testów - należy zrobić w osobnej zakładce ng serve podłączone do dowolnego środowiska ustawionego przez env.sh
